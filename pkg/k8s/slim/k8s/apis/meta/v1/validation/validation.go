...
func ValidateDeleteOptions(options *slim_metav1.DeleteOptions) field.ErrorList {
	allErrs := field.ErrorList{}
	...
	if options.PropagationPolicy != nil &&
		*options.PropagationPolicy != slim_metav1.DeletePropagationForeground &&
		*options.PropagationPolicy != slim_metav1.DeletePropagationBackground &&
		*options.PropagationPolicy != slim_metav1.DeletePropagationOrphan {
		allErrs = append(allErrs, field.NotSupported(field.NewPath("propagationPolicy"), options.PropagationPolicy, []string{string(slim_metav1.DeletePropagationForeground), string(slim_metav1.DeletePropagationBackground), string(slim_metav1.DeletePropagationOrphan), "nil"}))
	}
	allErrs = append(allErrs, ValidateDryRun(field.NewPath("dryRun"), options.DryRun)...)
	return allErrs
}

func ValidateCreateOptions(options *slim_metav1.CreateOptions) field.ErrorList {
	allErrs := field.ErrorList{}
...
func ValidateUpdateOptions(options *slim_metav1.UpdateOptions) field.ErrorList {
	allErrs := field.ErrorList{}
	allErrs = append(allErrs, ValidateFieldManager(options.FieldManager, field.NewPath("fieldManager"))...)
	allErrs = append(allErrs, ValidateDryRun(field.NewPath("dryRun"), options.DryRun)...)
	allErrs = append(allErrs, ValidateFieldValidation(field.NewPath("fieldValidation"), options.FieldValidation)...)
...
func ValidatePatchOptions(options *slim_metav1.PatchOptions, patchType types.PatchType) field.ErrorList {
	allErrs := field.ErrorList{}
...
var allowedDryRunValues = sets.NewString(slim_metav1.DryRunAll)
...
func ValidateTableOptions(opts *slim_metav1.TableOptions) field.ErrorList {
	var allErrs field.ErrorList
	switch opts.IncludeObject {
	case slim_metav1.IncludeMetadata, slim_metav1.IncludeNone, slim_metav1.IncludeObject, "":
	default:
...
func ValidateManagedFields(fieldsList []slim_metav1.ManagedFieldsEntry, fldPath *field.Path) field.ErrorList {
	var allErrs field.ErrorList
	for i, fields := range fieldsList {
		fldPath := fldPath.Index(i)
		switch fields.Operation {
		case slim_metav1.ManagedFieldsOperationApply, slim_metav1.ManagedFieldsOperationUpdate:
		default:
