...
type PersistentVolumeStatus struct {
	...
	// +optional
	LastPhaseTransitionTime *slim_metav1.Time `json:"lastPhaseTransitionTime,omitempty" protobuf:"bytes,4,opt,name=lastPhaseTransitionTime"`
}
...
type ClusterTrustBundleProjection struct {
	...
	// everything".
	// +optional
	LabelSelector *slim_metav1.LabelSelector `json:"labelSelector,omitempty" protobuf:"bytes,3,rep,name=labelSelector"`
...
type PodAffinityTerm struct {
	...
	// +optional
	LabelSelector *slim_metav1.LabelSelector `json:"labelSelector,omitempty" protobuf:"bytes,1,opt,name=labelSelector"`
	...
	// +optional
	NamespaceSelector *slim_metav1.LabelSelector `json:"namespaceSelector,omitempty" protobuf:"bytes,4,opt,name=namespaceSelector"`
...
type TopologySpreadConstraint struct {
	...
	// +optional
	LabelSelector *slim_metav1.LabelSelector `json:"labelSelector,omitempty" protobuf:"bytes,4,opt,name=labelSelector"`
...
type ReplicationControllerCondition struct {
	...
	// +optional
	LastTransitionTime slim_metav1.Time `json:"lastTransitionTime,omitempty" protobuf:"bytes,3,opt,name=lastTransitionTime"`
...
type PreferAvoidPodsEntry struct {
	...
	// +optional
	EvictionTime slim_metav1.Time `json:"evictionTime,omitempty" protobuf:"bytes,2,opt,name=evictionTime"`
...
type PodSignature struct {
	...
	// +optional
	PodController *slim_metav1.OwnerReference `json:"podController,omitempty" protobuf:"bytes,1,opt,name=podController"`
}
...
const (
	...
	NamespaceTerminatingCause slim_metav1.CauseType = "NamespaceTerminating"
)
...
type EventSeries struct {
	...
	LastObservedTime slim_metav1.MicroTime `json:"lastObservedTime,omitempty" protobuf:"bytes,2,name=lastObservedTime"`
